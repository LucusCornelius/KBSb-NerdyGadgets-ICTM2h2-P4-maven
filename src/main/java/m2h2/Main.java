...
public static void main(String[] args) {
    ...
    try (
        ...
        String sql = "SELECT openbare_ruimte_naam, postcode, woonplaats_naam, huisnummer FROM verblijfsobject WHERE verblijfsobject.woonplaats_naam LIKE 'Amsterdam' AND huisletter IS NULL LIMIT 500";
